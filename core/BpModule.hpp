...
protected:
    ...
    */
    virtual bool Init(const std::string& json_path) = 0;
    ...
    */
    ...
    std::unordered_set<std::string> _module_symbols;
    std::unordered_map<std::string, BpModuleFunc> _module_funcs;
    std::unordered_map<std::string, module_create_val_func_t> _create_var_funcs;
